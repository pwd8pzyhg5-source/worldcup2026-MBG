  ...
  return (
    <div style={{ maxWidth: 1200, margin: "0 auto", padding: "24px 16px" }}>
      ...
      <div style={{ position: "relative", borderRadius: 12, overflow: "hidden", marginBottom: 24, height: 140 }}>
        ...
        <img src="/images/wc-ball.webp" alt="World Cup Ball" style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "center center", transform: "scale(0.75)", transformOrigin: "center center" }} />
