      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "16px 12px" }}>
        ...
        <div className="card" style={{ padding: "16px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(180px, 1fr))", gap: 6 }}>
            {[["Group win","3"],["Group draw","1"],["Clean sheet","2"],["Goal scored","1"],["Upset win (ranked 30+ beats top 10)","3"],["Upset draw (ranked 30+ draws top 10)","1"],["Round of 32","2"],["Round of 16","4"],["Quarter-Final","6"],["Bronze Medal","9"],["Runner-up","11"],["Champion","15"],["Red card","-2"],["2 yellows","-1"]].map(([label, pts]) => (
